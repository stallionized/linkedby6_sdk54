...
const BusinessProfileSlider = ({ isVisible, onClose, businessId, userId, viewSource = 'other' }) => {
  ...
  const handlePhoneCall = (phone) => {
    if (!phone || phone === 'Not specified') return;
  ...
  const handleDirectMessage = async (businessId) => {
    try {
      ...
      // For mobile, you might want to navigate to a messages screen
      // navigation.navigate('Messages', { businessId });
      Alert.alert("Direct Message", "Direct messaging feature will be implemented in the messages screen.");
                  ...
                  <View style={styles.businessInfoContainer}>
                    ...
                    {!reviewMode && (
                      <View style={styles.quickContactContainer}>
                        ...
                        <TouchableOpacity 
                          style={styles.quickContactButton}
                          onPress={() => handleDirectMessage(profileData.businessId)}
                        >
